...
config.main.exp_name = 'RG_map5_no_punish_test2'
...
config.sender.epsilon_greedy = 0.5
config.sender.epsilon_decay = 0.99996  # after generating every episode: epsilong <- epsilon * coe_decay
